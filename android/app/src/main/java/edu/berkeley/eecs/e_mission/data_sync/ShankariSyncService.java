 ...
 *
 */
public class ShankariSyncService extends AbstractThreadedSyncAdapter implements SyncingInterface {
    ...
    public ShankariSyncService(Context context, boolean autoInitialize) {
